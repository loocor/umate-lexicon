...
3. Ingest in lock order after gold: Unihan readings, variants (t2s), kTGH (8105), CC-CEDICT, THUOCL, official luna, essay, emoji, Tencent light vocab (`tencent-light`, coverage only), zhwiki titles. Luna/essay/emoji/tencent/wiki surfaces are simplified before overlay. Wiki-only lemmas emit to bulk. The Tencent pin is the ModelScope light subset, not the official ~8M dump.
